...
define([
	...
	coreFx.wipeIn = function(/*Object*/ args){
		...
		//		node defined in 'config_name' object from it's current height to
	...
	coreFx.wipeOut = function(/*Object*/ args){
		...
		//
		// description:
		//		Returns an animation that will shrink node defined in "config_name"
	...
	coreFx.slideTo = function(/*Object*/ args){
		...
		//		defined in config_name Object from its current position to
		//		the position defined by (config_name.left, config_name.top).
		//
		// config_name: Object
		//		A hash-map of standard `dojo/_base/fx.Animation` constructor properties
		//		(such as easing: node: duration: and so on). Special config_name members
...
dojo.declare("dojox.mobile.app.StageController", null,{
	...
	popScene: function(data){
		//	performTransition: function(/*String*/moveTo, /*Number*/dir, /*String*/transition,
			//						/*Object|null*/context, /*String|Function*/method /*optional config_name*/){
		if(this._opInProgress){
			return;
		}
...
define([
	...
	/*=====
	 var __OpenArgs = {
		 ...
		 //		   i.e. whenever popupWidget.onCancel() is called, config_name.onCancel is called
		 // onClose: Function
